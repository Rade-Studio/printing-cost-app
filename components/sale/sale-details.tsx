...
export function SaleDetails({ saleId, onBack, onAddDetail, onEditDetail, refreshTrigger }: SaleDetailsProps) {
  ...
  return (
    <>
                      ...
                      <TableRow key={detail.id}>
                        ...
                        <TableCell className="text-right">
                          <div className="flex justify-end gap-2">
                            ...
                            <Button variant="outline" size="sm" onClick={() => setDeleteDetail(detail)}>
      ...
      <AlertDialog open={!!deleteDetail} onOpenChange={() => setDeleteDetail(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>¿Estás seguro?</AlertDialogTitle>
            <AlertDialogDescription>
              Esta acción no se puede deshacer. Se eliminará permanentemente este producto de la venta.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>Cancelar</AlertDialogCancel>
            <AlertDialogAction onClick={() => deleteDetail && handleDelete(deleteDetail)}>Eliminar</AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
    </>
